...
var ASM_CONSTS = {
  88558: () => { if (document.fullscreenElement) return 1; },  
 88604: () => { return Module.canvas.width; },  
 88636: () => { return parseInt(Module.canvas.style.width); },  
 88684: () => { document.exitFullscreen(); },  
 88711: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 88783: () => { if (document.fullscreenElement) return 1; },  
 88829: () => { return Module.canvas.width; },  
 88861: () => { return screen.width; },  
 88886: () => { document.exitFullscreen(); },  
 88913: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89107: () => { return window.innerWidth; },  
 89133: () => { return window.innerHeight; },  
 89160: () => { if (document.fullscreenElement) return 1; },  
 89206: () => { return Module.canvas.width; },  
 89238: () => { return parseInt(Module.canvas.style.width); },  
 89286: () => { if (document.fullscreenElement) return 1; },  
 89332: () => { return Module.canvas.width; },  
 89364: () => { return screen.width; },  
 89389: () => { return window.innerWidth; },  
 89415: () => { return window.innerHeight; },  
 89442: () => { if (document.fullscreenElement) return 1; },  
 89488: () => { return Module.canvas.width; },  
 89520: () => { return screen.width; },  
 89545: () => { document.exitFullscreen(); },  
 89572: () => { if (document.fullscreenElement) return 1; },  
 89618: () => { return Module.canvas.width; },  
 89650: () => { return parseInt(Module.canvas.style.width); },  
 89698: () => { document.exitFullscreen(); },  
 89725: ($0) => { Module.canvas.style.opacity = $0; },  
 89763: () => { return screen.width; },  
 89788: () => { return screen.height; },  
 89814: () => { return window.screenX; },  
 89841: () => { return window.screenY; },  
 89868: () => { return window.devicePixelRatio; },  
 89904: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 89957: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90008: () => { Module.canvas.style.cursor = 'none'; },  
 90045: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90301: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90352: () => { if (document.pointerLockElement) return 1; },  
 90399: () => { if (document.fullscreenElement) return 1; },  
 90445: () => { return window.innerWidth; },  
 90471: () => { return window.innerHeight; }
};
